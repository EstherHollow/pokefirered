...
MAP_TRANSITIONS := $(patsubst $(MAPS_DIR)/%/,$(MAPS_DIR)/%/transition.inc,$(MAP_DIRS))
...
$(DATA_ASM_BUILDDIR)/maps.o: $(DATA_ASM_SUBDIR)/maps.s $(LAYOUTS_DIR)/layouts.inc $(LAYOUTS_DIR)/layouts_table.inc $(MAPS_DIR)/headers.inc $(MAPS_DIR)/groups.inc $(MAPS_DIR)/connections.inc $(MAP_CONNECTIONS) $(MAP_TRANSITIONS) $(MAP_HEADERS)
