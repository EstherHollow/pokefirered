...
// [EH] The debug functions for MGBA were not present in the pokefirered
// disassembly. The following, and other code particularly in isagbprint,
// was copied from pokeemerald.
