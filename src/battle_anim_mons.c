...
u8 CreateAdditionalMonSpriteForMoveAnim(u16 species, bool8 isBackpic, u8 templateId, s16 x, s16 y, u8 subpriority, u32 personality, u8 variant, u32 battlerId, bool32 ignoreDeoxys)
{
    u8 spriteId;
    ...
    if (!isBackpic)
    {
        LoadCompressedPalette(GetMonSpritePalFromVariant(species, variant), (palette * 0x10) + 0x100, 0x20);
