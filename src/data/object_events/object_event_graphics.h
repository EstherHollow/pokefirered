...
const u16 gObjectEventPic_Sparkle[] = INCBIN_U16("graphics/object_events/pics/misc/sparkle.4bpp");
const u16 gObjectEventPal_Sparkle[] = INCBIN_U16("graphics/object_events/palettes/sparkle.gbapal");
