...
const struct VariantStats gVariantStats[][8] =
{
        ...
        [SPECIES_PIDGEY] = {
                ...
                [PALETTE_PIDGEY_BLACK] = VARIANT_ALTER_STATS(50, 35, UNCHANGED, UNCHANGED, 50, 45),
                [PALETTE_PIDGEY_RED] = VARIANT_ALTER_STATS(UNCHANGED, 55, MAINTAIN_BST, UNCHANGED, UNCHANGED, UNCHANGED),
                [PALETTE_PIDGEY_BLUE] = VARIANT_ALTER_STATS(UNCHANGED, UNCHANGED, 60, MAINTAIN_BST, UNCHANGED, MAINTAIN_BST),
                [PALETTE_PIDGEY_YELLOW] = VARIANT_ALTER_STATS(MAINTAIN_BST, UNCHANGED, MAINTAIN_BST, 72, UNCHANGED, UNCHANGED),
        },
        [SPECIES_PIDGEOTTO] = {0},
        [SPECIES_PIDGEOT] = {0},
        [SPECIES_RATTATA] = {
                [PALETTE_RATTATA_BLUE] = VARIANT_SUBSTITUTE_MOVE(MOVE_TACKLE, 1, MOVE_RAGE),
