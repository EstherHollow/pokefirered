...
struct InGameTrade {
    ...
    /*0x0C*/ u16 species;
    /*0x0E*/ u16 variant;
    /*0x10*/ u8 ivs[NUM_STATS];
    /*0x16*/ u8 abilityNum;
    /*0x1A*/ u32 otId;
    /*0x1E*/ u8 conditions[5];
...
static void CreateInGameTradePokemonInternal(u8 playerSlot, u8 inGameTradeIdx)
{
    ...
    u8 mailNum;
    CreateMon(tradeMon, inGameTrade->species, level, 32, TRUE, inGameTrade->personality, inGameTrade->otId, inGameTrade->variant, 0);
